...
public class CollisionUtility {
    public static boolean isCollidingWith(ITransformable first, ITransformable second) {
    ...
    public static boolean isCollidingWithWall(ITransformable object, Wall wall) {
        switch (wall) {
            case Top -> {
